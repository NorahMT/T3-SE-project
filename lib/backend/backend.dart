...
import 'schema/youtube_video_record.dart';
...
export 'schema/youtube_video_record.dart';
...
/// Functions to query YoutubeVideoRecords (as a Stream and as a Future).
Future<int> queryYoutubeVideoRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      YoutubeVideoRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<YoutubeVideoRecord>> queryYoutubeVideoRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      YoutubeVideoRecord.collection(parent),
      YoutubeVideoRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<YoutubeVideoRecord>> queryYoutubeVideoRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
